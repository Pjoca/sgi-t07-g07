...
class MyApp {
    ...
    initCameras() {
        ...
        const perspective2 = new THREE.PerspectiveCamera(70, aspect, 0.1, 1000)
        perspective2.position.set(-12, 6, 0)
        perspective2.lookAt(new THREE.Vector3(0, 2, 0));
        this.cameras['Default'] = perspective2
